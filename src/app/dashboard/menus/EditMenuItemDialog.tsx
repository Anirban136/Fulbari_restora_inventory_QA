...
export function EditMenuItemDialog({
  ...
  // Merge preset + existing DB categories for datalist suggestions
  ...
  const suggestions = Array.from(allPresets)

  // Resolve stored DB value (uppercase) back to a display string
