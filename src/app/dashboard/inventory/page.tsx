...
export default async function GlobalCatalogPage() {
  ...
  return (
    <div className="space-y-8 lg:space-y-12 relative px-4 pt-4 lg:pt-6 pb-20 max-w-[1600px] mx-auto">
      ...
      {/* Header Section */}
      <header className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6 lg:gap-8 pt-2 lg:pt-0">
        <div className="space-y-3 lg:space-y-4">
          <div className="flex items-center gap-3 lg:gap-4">
             <div className="p-3 lg:p-4 bg-primary/10 rounded-2xl lg:rounded-3xl border border-primary/20 shadow-[0_0_30px_rgba(16,185,129,0.1)]">
               <Layers className="text-primary w-6 h-6 lg:w-8 lg:h-8" />
             </div>
             <div>
               <h2 className="text-3xl lg:text-7xl font-black tracking-tighter text-white leading-none">
                 GLOBAL <span className="text-primary">CATALOG</span>
               </h2>
               <p className="text-muted-foreground mt-2 lg:mt-3 font-black text-[9px] lg:text-xs tracking-[0.3em] lg:tracking-[0.4em] uppercase opacity-60">
