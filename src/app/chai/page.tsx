            ...
            <div className="lg:col-span-8 space-y-6 order-2 lg:row-span-2">
               <div className="flex items-center justify-between px-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest bg-blue-500/20 text-blue-400 border border-blue-500/20 animate-pulse">Live</span>
                  </div>
               </div>
